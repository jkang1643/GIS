...
class Geary_Tester(unittest.TestCase):
    ...
    def test_Geary(self):
        ...
        self.assertAlmostEqual(c.VC_rand,0.033411917666958356)
        self.assertAlmostEqual(c.p_rand,0.00013165646189214729)
        self.assertAlmostEqual(c.z_rand, -3.6489513837253944)
        self.assertAlmostEqual(c.seC_rand, 0.18278927120309429)
