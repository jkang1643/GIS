...
def get_logo():
    logo = html.Div([
        ...
        html.Div([
            html.Img(src='https://i.imgur.com/QAaUgnx.png', height='80', width='240')
        ], className="ten columns padded"),

        html.Div([
            dcc.Link('View All Pages   ', href='/full-view')
...
def get_header():
    header = html.Div([
        ...
        html.Div([
            html.H5(
                'Olive Appraisal Report', style={'position': "center"})
        ])
            ...
            html.Div([
                ...
                dcc.Graph(
                    ...
                    figure={
                        'data': [
                            go.Scatter(
                                x=["2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027",
                                   "2028"],
                                y=["$10,392,389.00", "$11,392,389.00", "13,392,389.00", "15,392,389.00",
                                   "15,392,389.00", "14,392,389.00", "16,392,389.00", "17,392,389.00", "16,792,389.00",
                                   "18,792,389.00", "20,792,389.00"],
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Div([
                        ...
                        html.P([
                                   "We charge participants a $25 annual account service fee for each fund they hold in their Vanguard SIMPLE IRA. This fee does not apply to members of Flagship Select, Flagship, Voyager Select, and Voyager Services."]),
                        html.Br([]),
                        html.Strong(["403(b)(7) plans"]),
                        html.P([
                                   "We charge participants a $15 annual account service fee for each fund they hold in their Vanguard 403(b)(7) account. This fee does not apply to members of Flagship Select, Flagship, Voyager Select, and Voyager Services."]),
                        html.Br([]),
                        html.Strong(["Individual 401(k) plans"]),
                        html.P([
                                   "We charge participants a $20 annual account service fee for each fund they hold in their Vanguard Individual 401(k) account. This fee will be waived for all participants in the plan if at least 1 participant qualifies for Flagship Select, Flagship, Voyager Select, and Voyager Services"]),
                        html.Br([]),
                    ], className="nine columns")
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Br([]),
                html.P(
                    "Did you know? The fund launched in 1976 as Vanguard First Index Investment Trust—the nation's first index fund available to individual investors."),
                html.Br([]),
                html.P(
